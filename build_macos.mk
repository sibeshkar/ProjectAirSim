...
# Abstract:
#
#   Main makefile for macOS builds (Apple Silicon) to drive CMake/UBT commands.
#
# ---------------------------------------------------------------------------------------------------------------------
...
CMAKE_BUILD_DIR = build/darwin_arm64
...
config_simlibs_debug:
	@echo "======================================================================="
	@echo "Configuring the ProjectAirSimLibs project for Darwin-ARM64-Debug..."
...
simlibs_debug: config_simlibs_debug
	@echo "======================================================================="
	@echo "Building the ProjectAirSimLibs project for Darwin-ARM64-Debug..."
	$(CMAKE_DBG_BUILD_CMD)

.PHONY: config_simlibs_release
config_simlibs_release:
	@echo "======================================================================="
	@echo "Configuring the ProjectAirSimLibs project for Darwin-ARM64-Release..."
...
simlibs_release: config_simlibs_release
	@echo "======================================================================="
	@echo "Building the ProjectAirSimLibs project for Darwin-ARM64-Release..."
	$(CMAKE_REL_BUILD_CMD)
...
test_simlibs_debug: simlibs_debug
	@echo "======================================================================="
	@echo "Testing the ProjectAirSimLibs project for Darwin-ARM64-Debug..."
	$(CMAKE_DBG_TEST_CMD)

.PHONY: test_simlibs_release
test_simlibs_release: simlibs_release
	@echo "======================================================================="
	@echo "Testing the ProjectAirSimLibs project for Darwin-ARM64-Release..."
	$(CMAKE_REL_TEST_CMD)
...
ifndef UE_ROOT
	...
	Unreal engine's root folder path, ex. /Users/Shared/Epic Games/UE_5.7"
else
	@echo "UE_ROOT env variable set to: $(UE_ROOT)"
	"$(UE_ROOT)/Engine/Build/BatchFiles/Mac/Build.sh" Blocks Mac DebugGame \
		-project="$(CURDIR)/unreal/Blocks/Blocks.uproject"
	"$(UE_ROOT)/Engine/Build/BatchFiles/Mac/Build.sh" BlocksEditor Mac DebugGame \
		-project="$(CURDIR)/unreal/Blocks/Blocks.uproject"
endif
...
ifndef UE_ROOT
	...
	@echo "UE_ROOT env variable set to: $(UE_ROOT)"
	"$(UE_ROOT)/Engine/Build/BatchFiles/Mac/Build.sh" Blocks Mac Development \
		-project="$(CURDIR)/unreal/Blocks/Blocks.uproject"
endif
...
ifndef UE_ROOT
	...
	@echo "UE_ROOT env variable set to: $(UE_ROOT)"
	"$(UE_ROOT)/Engine/Build/BatchFiles/Mac/Build.sh" Blocks Mac Shipping \
		-project="$(CURDIR)/unreal/Blocks/Blocks.uproject"
endif
